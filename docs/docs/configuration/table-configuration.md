...
| `lf_tags_config`    | **Available since adapter version 1.5.1**  <br/>Lake Formation tags for metadata access control, to associate to the table. See detailed instructions [here](./lakeformation)                                                                                   | `none`                |
| `lf_grants`         | **Available since adapter version 1.5.1**  <br/>Lake Formation tags for metadata access control, to associate to columns. See detailed instructions [here](./lakeformation)                                                                                     | `none`                |
